...
<context>
    ...
    <message>
        ...
        <translation>交易费(ESR/kb)比这更小的交易在转发时将被视为零费交易 (默认: %s) </translation>
    </message>
    <message>
        <source>Fees (in ESR/Kb) smaller than this are considered zero fee for transaction creation (default: %s)</source>
        <translation>交易费(ESR/kb)比这更小的交易在生成交易时将被视为零费交易 (默认: %s) </translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "Elspero Alert" admin@foo.com
        ...
        <translation>要使用 elsperod 或者 elspero-qt 中的 -server 选项，您必须在配置文件中设置一个密码：
%s
建议您使用下列随机密码：
rpcuser=elsperorpc
rpcpassword=%s
...
例如 alertnotify=echo %%s | mail -s "Elspero Alert" admin@foo.com
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>为付款交易添加交易费 (ESR/kb) (默认: %s) </translation>
    </message>
    <message>
        <source>Information</source>
        <translation>信息</translation>
