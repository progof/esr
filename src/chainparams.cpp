...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("142.93.136.254"));
        ...
        // Elspero: Mainnet v2 enforced as of block 710k
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("46.101.13.106"));

        base58Prefixes[PUBKEY_ADDRESS] = list_of(93);
        ...
        // Elspero: Testnet v2 enforced as of block 400k
...
public:
    CRegTestParams() {
        ...
        // Elspero: v2 enforced using Bitcoin's supermajority rule
